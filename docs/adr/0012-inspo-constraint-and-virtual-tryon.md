...
- ⚠️ **后续（2026-09-10）· 决策三「真·虚拟试衣」已整体退役**：aitryon 前端入口与云函数渠道均被**主动移除**，保真诉求改由「演绎」链路承担。本文保留为**设计历史**；下方与「试衣」相关的落地状态、待办、附录中的具体做法均已失效。退役记录见 `docs/tickets/0008-model-lifecycle-migration/01-retire-tryon-entry.md`。
- 决策人：用户（A/A/A 三选）
